# 
# You're putting together contact information for all the users of your website 
# to ship them a small gift. You queried your database and got back a list of users,
# where each user is another list with up to two items: a string representing the 
# user's name and their shipping zip code. Example data might look like:
...
# Write a function user_contacts() that takes a two-dimensional list like the one
# above and returns a dictionary with an item for each user where the key is the 
